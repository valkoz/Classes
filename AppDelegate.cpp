...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    {        
    	CCLOG("frameSize.height > mediumResolutionSize.height");
        director->setContentScaleFactor(MIN(largeResolutionSize.height/designResolutionSize.height, largeResolutionSize.width/designResolutionSize.width));
    }
    // if the frame's height is larger than the height of small size.
    else if (frameSize.height > smallResolutionSize.height)
    {        
    	CCLOG("frameSize.height > smallResolutionSize.height");
    ...
    if (frameSize.height == 1080)
    	director->setContentScaleFactor(MIN(1080/designResolutionSize.height, 1920/designResolutionSize.width));
